...
import { Users } from '../components/app/account/users/Users';
import { Groups } from '../components/app/account/groups/Groups';
import { NewUser } from '../components/app/account/users/NewUser/NewUser';
  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayout />}>
        {/*Dashboard*/}
        <Route path="accounts/user" element={<Users />} />
        <Route path="accounts/user/new" element={<NewUser />} />
        <Route path="accounts/group" element={<Groups />} />
        <Route path="dashboard/saas" element={<Saas />} />
        {isAuthenticated && <Route path="/" element={<Ecommerce />} />}
